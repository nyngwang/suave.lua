...
badd +1 ~/GitHub/suave.lua/README.md
badd +4 lua/suave.lua
badd +27 term://~/GitHub/suave.lua//65458:/bin/zsh
badd +33 term://~/GitHub/suave.lua//84231:/bin/zsh
argglobal
%argdel
set stal=2
tabnew +setlocal\ bufhidden=wipe
tabrewind
edit ~/GitHub/suave.lua/README.md
...
set winminwidth=0
set winwidth=1
exe 'vert 1resize ' . ((&columns * 82 + 103) / 206)
exe 'vert 2resize ' . ((&columns * 123 + 103) / 206)
argglobal
balt lua/suave.lua
let s:cpo_save=&cpo
set cpo&vim
...
inoremap <buffer> <silent> ( =AutoPairsInsert('(')
inoremap <buffer> <silent> ) =AutoPairsInsert(')')
inoremap <buffer> <silent> > >:lua require('nvim-ts-autotag.internal').close_tag()a
inoremap <buffer> <silent> [ =AutoPairsInsert('[')
inoremap <buffer> <silent> ] =AutoPairsInsert(']')
inoremap <buffer> <silent> ` =AutoPairsInsert('`')
inoremap <buffer> <silent> { =AutoPairsInsert('{')
...
setlocal statusline=%<%#lualine_c_inactive#\ README.md\ %#lualine_c_inactive#%=%#lualine_c_inactive#\ \ 47:1\ \ 
...
balt ~/GitHub/suave.lua/README.md
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <silent> <M-n> :call AutoPairsJump()a
inoremap <buffer> <silent> <expr> <M-p> AutoPairsToggle()
