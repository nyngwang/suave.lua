...
badd +217 lua/suave.lua
badd +1 ~/GitHub/suave.lua
badd +7 ~/GitHub/suave.lua/README.md
...
setlocal formatoptions=njcroql
...
setlocal statusline=%#lualine_a_normal#\ COMMAND\ %#lualine_transitional_lualine_a_normal_to_lualine_b_normal#%#lualine_b_normal#\ \ main\ %#lualine_b_diff_added_command#\ +28\ %#lualine_b_diff_modified_command#~2\ %#lualine_b_diff_removed_command#-2\ %#lualine_b_normal#%#lualine_b_diagnostics_error_command#\ \ 1\ %#lualine_b_diagnostics_hint_command#\ 3\ %#lualine_transitional_lualine_b_diagnostics_hint_command_to_lualine_c_normal#%<%#lualine_c_normal#\ suave.lua\ %#lualine_c_normal#%=%#lualine_c_normal#\ utf-8\ %#lualine_x_filetype_DevIconLua_command#\ %#lualine_c_normal#\ lua\ %#lualine_transitional_lualine_b_normal_to_lualine_c_normal#%#lualine_b_normal#\ 95%%\ %#lualine_transitional_lualine_a_normal_to_lualine_b_normal#%#lualine_a_normal#\ 217:21\ 
...
217
normal! zo
let s:l = 217 - ((57 * winheight(0) + 33) / 66)
...
wincmd w
argglobal
if bufexists(fnamemodify("~/GitHub/suave.lua/README.md", ":p")) | buffer ~/GitHub/suave.lua/README.md | else | edit ~/GitHub/suave.lua/README.md | endif
if &buftype ==# 'terminal'
  silent file ~/GitHub/suave.lua/README.md
endif
balt lua/suave.lua
let s:cpo_save=&cpo
set cpo&vim
...
setlocal spelllang=en
setlocal spelloptions=noplainbuffer
setlocal statusline=%<%#lualine_c_inactive#\ README.md\ %#lualine_c_inactive#%=%#lualine_c_inactive#\ \ 42:1\ \ 
